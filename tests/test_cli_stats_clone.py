...
from pydantic_invoices.schemas import Invoice, InvoiceStatus, InvoiceLine
...
def test_clone_command(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    original_invoice = Invoice.model_construct(
        ...
        tax_amount=0.0,
        lines=[
            InvoiceLine.model_construct(description="Item 1", quantity=1, unit_price=100.0, line_total=100.0)
        ],
    ...
    new_invoice = original_invoice.model_copy(update={"id": 2, "number": "INV-2024-002", "status": InvoiceStatus.UNPAID})
