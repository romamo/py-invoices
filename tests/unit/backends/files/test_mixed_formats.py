...
def test_mixed_formats_reading(storage_dir):
...
def test_default_writing_format(storage_dir):
    ...
    # Case 2: Default JSON
    storage_json = FileStorage[ItemModel](storage_dir, "items_json", ItemModel, default_format="json")
