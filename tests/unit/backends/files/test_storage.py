...
def test_storage_initialization(storage_dir):
    storage = FileStorage(storage_dir, "items", ItemModel)
...
def test_save_load_xml(storage):
...
def test_xml_list_handling(storage):
...
def test_xml_none_value(storage):
